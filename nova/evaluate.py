...
if __name__ == '__main__':
    ...
    run_testcases('../benchmark/humaneval_decompile_nova_6.7b.json', wd)
    calculate_passk('../benchmark/humaneval_decompile_nova_6.7b.json', N=20, k=1)
    calculate_passk('../benchmark/humaneval_decompile_nova_6.7b.json', N=20, k=10)
