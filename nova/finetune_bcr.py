...
model = NovaForCausalLM.from_pretrained(model_load_folder, torch_dtype=torch.float16)
...
# Load train data
train_data_dirs = [
    '../data-tokenized/nova-the-stack-bcr/train', '../data-tokenized/nova-anghabench-bcr/train',
]
train_data = concatenate_datasets([
    load_from_disk(data_dir) for data_dir in train_data_dirs
...
# Load valid data
valid_data_dirs = [
    '../data-tokenized/nova-the-stack-bcr/valid', '../data-tokenized/nova-anghabench-bcr/valid',
]
valid_data = concatenate_datasets([
    load_from_disk(data_dir) for data_dir in valid_data_dirs
]).shuffle(seed=7, keep_in_memory=True)
